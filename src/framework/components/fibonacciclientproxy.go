...
func (FibonacciClientProxy) I_PreInvR(msg *messages.SAMessage, info interface{}, r *bool) {
	*msg = <-i_PreInvRFibonacciClientProxy
}

func (FibonacciClientProxy) I_PosTerR(msg *messages.SAMessage, info interface{}, r *bool) {
