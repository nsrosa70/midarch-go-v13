...
type QueueingInvoker1 struct{}

var QM1 queueing.QueueingServer

func (QueueingInvoker1) I_PosInvP(msg *message.Message) {
	...
	case "Publish":
		...
		_r := queueing.QueueingServer{}.Publish(_p1, _p2) // dispatch
	...
	case "Consume":
		...
		_argsX := _args.([]interface{})
		_p1 := _argsX[0].(string)
		_r := queueing.QueueingServer{}.Consume(_p1)
