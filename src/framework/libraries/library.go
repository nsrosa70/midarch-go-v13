...
var Repository = map[string]Record{
	...
	//"components.NotificationEngine":            Record{RBD: "TODO", PRISM: "TODO", Go: components.NotificationEngine{}, CSP: "B = InvP.e1 -> I_PosInvP -> ( I_PreInvR2 -> InvR.e2 -> TerR.e2 -> TerP.e1 -> B [] I_PreInvR3 -> InvR.e3 -> TerR.e3 -> TerP.e1-> B )"},
