...
func NewInvoker(invP, terP, invR1, terR1, invR2, terR2  *chan messages.SAMessage) Invoker {
	...
	newEdgeInfo = graphs.EdgeExecutableInfo{InternalAction: Invoker{}.I_DeserialiseMIOP, Message: &r.Msg, ActionType: 1, ActionChannel: &actionChannel, Args:r.Args}
	...
	actionChannel = make(chan messages.SAMessage)
	newEdgeInfo = graphs.EdgeExecutableInfo{InternalAction: Invoker{}.I_PrepareToObject, Message: &r.Msg, ActionType: 1, ActionChannel: &actionChannel, Args:r.Args}
...
func (Invoker) I_DeserialiseMIOP(msg *messages.SAMessage){
	fmt.Println("Invoker:: I_DeserialiseMIOP")
	os.Exit(0)
}
...
func (Invoker) I_SerialiseMIOP(msg *messages.SAMessage, args [] *interface{}) {
...
func (Invoker) I_PrepareToCRH(msg *messages.SAMessage, args [] *interface{}) {
