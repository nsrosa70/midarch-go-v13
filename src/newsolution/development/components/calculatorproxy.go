...
func (c *CalculatorProxy) Configure(invP, terP, invR, terR *chan messages.SAMessage) CalculatorProxy {
	...
	*info[0] = msg
	...
	newEdgeInfo = exec.ExecEdgeInfo{InternalAction: shared.Invoke, ActionName: "I_Processin", ActionType: 1, ActionChannel: &actionChannel, Message: msg, Info: info}
	...
	newEdgeInfo = exec.ExecEdgeInfo{InternalAction: shared.Invoke, ActionName: "I_Processout", ActionType: 1, ActionChannel: &actionChannel, Message: msg, Info: info}
